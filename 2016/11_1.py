...
hash_order = ['elv', 'com', 'cum', 'rum', 'plm', 'prm', 'cog', 'cug', 'rug', 'plg', 'prg']
...
def check_valid(move, state_dict, seen_states):
    ...
    for checker_position in range(1, 6):
        if state_hash[checker_position] != state_hash[checker_position + 5]:
            if state_hash[checker_position] in state_hash[-5:]:
                return False, ()
